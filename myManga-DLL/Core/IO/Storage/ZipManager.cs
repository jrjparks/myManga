...
namespace Core.IO.Storage
{
    public sealed class ZipManager : IDisposable
    {
        ...
        {
            Task<Stream> readTask = ReadAsync(FileName, EntryName);
            readTask.Wait();
        ...
        {
            Task<Boolean> writeTask = WriteAsync(FileName, EntryName, EntryStream);
            writeTask.Wait();
        ...
        {
            Task<Boolean> deleteTask = DeleteAsync(FileName, EntryName);
            deleteTask.Wait();
